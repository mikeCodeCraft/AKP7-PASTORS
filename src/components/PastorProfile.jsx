...
/**
 * PastorProfile - standalone profile view
 * Props:
 * - pastor: the selected pastor object
 * - onBack: () => void
 */
const PastorProfile = ({ pastor, onBack }) => {
          ...
          <div className="bg-white rounded-lg shadow">
            ...
            <div className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="text-gray-900">{new Date(pastor.anniversary).toLocaleDateString()}</p>
              </div>
            </div>
          </div>
